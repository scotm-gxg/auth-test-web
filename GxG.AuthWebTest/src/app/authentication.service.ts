...
export class AuthenticationService {
    ...
    constructor() {
        this.clientApplication = new Msal.UserAgentApplication(environment.clientID, this.authority, AuthenticationService.authCallback)
    }

    public login(): Promise<string> {
        return this.clientApplication.loginPopup(environment.b2cScopes);
    }
        ...
        return this.clientApplication.acquireTokenSilent(environment.b2cScopes)
            ...
            .catch(error => {
                ...
                return this.clientApplication.acquireTokenPopup(environment.b2cScopes)
                    ...
                    .catch(innererror => {
                        console.log('could not rerieve token from popup.', innererror);
                        return Promise.resolve('');
                    });
            });
    }

    private static authCallback(errorDesc: any, token: any, error: any, tokenType: any) {
